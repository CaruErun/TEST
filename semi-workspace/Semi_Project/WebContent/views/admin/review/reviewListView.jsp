...
<body>
        ...
        <div id="content_2">
            ...
            <div id="content_2_4">
                <button type="button" class="btn btn-warning" id="selectAll">모두선택</button>
...
<!--                             <td><img src="/Semi/views/image/heart.png" alt="" width="40%"><</td> -->
            ...
            <div id="content_2_6">
                <ul class="pagination">
                	<%if(currentPage!=1){ %>
                    <li class="page-item"><a class="page-link" href="<%=contextPath%>/list.ro?cpage=<%=currentPage-1%>">&lt;</a></li>
                    <%} %>
                    <%for(int i=startPage; i<=endPage; i++){ %>
                    	<%if(i!=currentPage){%>
                    		<li class="page-item"><a class="page-link" href="<%=contextPath%>/list.ro?cpage=<%=i%>"><%=i %></a></li>
                    	<%}else{ %>	
...
<%--     				location.href="<%=contextPath%>/deliting.no?nno="+$(".table-hover>tbody>tr").children().eq(1).text(); --%>
	   ...
	   $("#selectAll").click(function(){
		   if($("input[name=inserts]").is(":checked")){
			   $("input[name=inserts]").prop("checked",false);
		   }else{
			   $("input[name=inserts]").prop("checked",true);
		   }
