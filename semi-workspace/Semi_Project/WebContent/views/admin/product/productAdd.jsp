            ...
            <div id="body">
                    ...
                    <table>
                        <thead>
                            ...
                            <tr>
                                <td>상품가격</td>
                                <td><input type="text" name="price" id="" required></td>
                            </tr>
                            <tr>
                                <td>제품코드</td>
                                <td><input type="text" name="code" id="" required></td>
                            </tr>
                        </thead>
                        <tbody id="imgbody">
                            <tr class="imgtr">
                        ...
                        <tr>
                            <td>제작회사</td>
                            <td><input type="text" name="maker" id="" required></td>
                        </tr>
                        <tr>
                            <td>상세설명</td>
                        ...
                        <tr>
                            <td>사이즈</td>
                            <td><input type="text" name="size" id="" required></td>
                        </tr>
                        <tr>
                            <td>상품수량</td>
                            <td><input type="number" name="amount" id="" min="0" required></td>
                        </tr>
                        <tr>
                            <td>상품레벨</td>
                            <td><input type="number" name="level" id="" min="0" required></td>
                        </tr>
                        <tr>
