            ...
            <div id="content_2_2">
                <form action="search.no?cpage=1" method="post">
                    <div id="content_2_2_1">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="secondSelect" id="search_user" class="form-control" value="<%=secondSelect%>"/> 
                        </div>   
                        <div class="col-sm-3">
...
<!--                         </form>          -->
            ...
            <div id="content_2_6">
                <ul class="pagination">
                	<%if(currentPage!=1){ %>
                    <li class="page-item"><a class="page-link" href="<%=contextPath%>/search.no?cpage=<%=currentPage-1%>&firstSelect=<%=firstSelect%>&secondSelect=<%=secondSelect%>">&lt;</a></li>
                    <%} %>
                    <%for(int i=startPage; i<=endPage; i++){ %>
                    	<%if(i!=currentPage){%>
                    		<li class="page-item"><a class="page-link" href="<%=contextPath%>/search.no?cpage=<%=i%>&firstSelect=<%=firstSelect%>&secondSelect=<%=secondSelect%>"><%=i%></a></li>
                    	<%}else{ %>	
