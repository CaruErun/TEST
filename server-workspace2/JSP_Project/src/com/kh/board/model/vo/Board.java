...
public class Board {
	...
	public Board(int boardNo, int boardType, String categoryNo, String boardTitle, String boardContent, String boardWriter,
	...
	public Board(int boardNo, String categoryNo, String boardTitle, String boardContent) {
		super();
		this.boardNo = boardNo;
		this.categoryNo = categoryNo;
		this.boardTitle = boardTitle;
	...
	public Board(String categoryNo, String boardTitle, String boardContent, String boardWriter) {
		super();
		this.categoryNo = categoryNo;
		this.boardTitle = boardTitle;
		this.boardContent = boardContent;
	...
	public Board(String boardTitle, String boardContent, String boardWriter, Date createDate, String titleImg) {
		super();
		this.boardTitle = boardTitle;
		this.boardContent = boardContent;
		this.boardWriter = boardWriter;
