...
<body>
    ...
    <form id="updateform" action="<%=contextPath %>/update.no" method="post">
        ...
        <table align="center">
            <tr>
                <th width="50px">제목</th>
                <td width="400px"><input type="text" name="title" value="${notice.noticeTitle}" required></td>
            </tr>
            <tr>
                <th>내용</th>
                <td>
                    <textarea name="content" cols="30" rows="10" sylte="resize:none">${notice.noticeContent}</textarea>
                </td>
