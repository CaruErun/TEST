...
<body>
    ...
    <form id="mypage-form" action="${contextPath }/update.me" method="post">
        <table>
            <tr>
                <td>* 아이디</td>
                <td><input type="text" name="userId" maxlength="12" required value="${loginUser.userId }" readonly></td>
                <!-- <td><button type="button" onclick="">중복확인</button></td> -->
            </tr>
            <tr>
                <td>* 이름</td>
                <td><input type="text" name="userName" maxlength="6" required value="${loginUser.userName }"></td>
                <td></td>
            </tr>
            <tr>
                <td>전화번호</td>
